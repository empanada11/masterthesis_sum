...
def chunk_document(text, chunk_size=8192, overlap=512, tokenizer=None):
    if tokenizer is None:
        raise ValueError("A tokenizer must be provided for tokenization.")
...
def main():
    ...
    def preprocess_function(examples):
        ...
        chunked_inputs = []
        for inp in inputs:
            chunked_inputs.extend(chunk_document(inp, chunk_size=8192, overlap=512, tokenizer=tokenizer))

        inputs = [prefix + inp for inp in chunked_inputs]
